...
export const DOCUMENT_DATE = '13 April 2026'

export const PIS_ACK_LABEL =
  'I confirm that I have read and understood the Participant Information Sheet.'

export const ELECTRONIC_AFFIRMATION =
  'I confirm that my consent is informed, voluntary and provided electronically.'

export const pisText = `Participant Information Sheet
